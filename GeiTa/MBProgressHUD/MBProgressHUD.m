...
- (void)layoutSubviews {
    ...
    NSDictionary* attributesDic=[NSDictionary dictionaryWithObjectsAndKeys:UITextAttributeFont,label.font, nil];
    CGSize labelSize = [label.text sizeWithAttributes:attributesDic];
